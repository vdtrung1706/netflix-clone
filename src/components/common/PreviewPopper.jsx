            ...
            <div className="p-4 cursor-pointer">
              <div className="flex items-center content-center justify-between align-middle">
                ...
                <PreviewPopperTip
                  ...
                  placement="top"
                >
                  <div className="box-border relative w-10 h-10 p-1 duration-200 bg-white border-2 border-solid rounded-full bg-opacity-5 border-grey hover:border-white trnasition-all">
                    <svg
                      fill="none"
