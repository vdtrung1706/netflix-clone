...
const ToggleDislikedButton = forwardRef(
  ({ disliked, className, ...props }, ref) => {
    return (
      <button
        {...props}
        ref={ref}
...
ToggleDislikedButton.displayName = 'ToggleDislikedButton';

export default memo(ToggleDislikedButton);
