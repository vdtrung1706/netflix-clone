...
const DetailModal = ({
  ...
  useEffect(() => {
    ...
    onTransitionTimeout.current = setTimeout(() => setOnTransition(false), 200);
    return () => {
          ...
          <div className="relative flex flex-col w-full rounded-md bg-black-light box-shadow-full">
            {data ? (
                  ...
                  <div className="flex flex-col w-2/3 pl-10">
                    <div className="flex flex-wrap items-center content-center text-sm">
                      ...
                      <div className="flex items-center">
                        <span>
                          {data.release_date?.split('-')?.[0] || null}
                        </span>
              ...
              <div className="text-sm text-red">
                Failed to load data. Please check the others. We truly sorry
                about that!
              </div>
            )}
          </div>
